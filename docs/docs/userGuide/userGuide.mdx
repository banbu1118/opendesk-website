...
Moving the mouse to the top of the screen will display a floating toolbar, which supports the CAD (Ctrl+Alt+Del) shortcut, USB device redirection, and window mode.
