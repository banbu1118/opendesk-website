...
Enter the relevant parameters in the PVE configuration under System Settings, then save and the virtual machine will automatically restart to take effect.
...
Public proxy: https://192.168.1.60:9443 -> https://qianian012.uunat.com:9443

Internal proxy: https://192.168.1.60:8443 -> https://192.168.1.71:8443
...
Import, export, clone, and delete templates are supported.

Import: Upload a template or virtual machine backup file and restore it as a template in PVE.

Export: Export a PVE template as a backup file.

Clone: Fully clone a template into a new virtual machine, allowing the admin user to log in via the client and install software in the virtual machine.

Save: Convert a cloned virtual machine into a template.

Note: Import, export, and clone operations take a long time, please be patient.
